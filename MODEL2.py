...
dataaf = pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\MODEL2DATA\MODEL2DATA.csv")
...
model.fit(X_train, y_train_enc, batch_size=40, epochs=5)
accuracy = model.evaluate(X_test, y_test_enc, verbose=0)
print("Accuracy:", accuracy)


# saving the model
model.save(r'C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Model\codes\MODELS\MODEL2\MODEL2_E&F.h5')

import pickle

file_path = r'C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Model\codes\MODELS\MODEL2/tokenizer2.pickle'
