...
#reading data
Eapplication=pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\EMPRICAL\APPLICATION\EMPRICAL_APPLICATION.csv")
Efoundation=pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\EMPRICAL\FOUNDATION\EMPRICAL_FOUNDATION.csv")

Fapplication=pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\FORMAL\APPLICATION\FORMAL_APPLICATION.csv")
Ffoundation=pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\FORMAL\FOUNDATION\FORMAL_FOUNDATION.csv")

dataframes = [Eapplication,Efoundation, Fapplication, Ffoundation]
...
total_rows = 912434 # this is the number of raws make sure to put the right number
...
with tqdm(total=total_rows) as pbar:
    for i in range(len(dataaf["Text"])):
...
####
dataaf.to_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\AFTER NLP\SCIENTIFIC_PHASE1.csv",index=False)


dataaf=pd.read_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\AFTER NLP\SCIENTIFIC_PHASE1.csv")
...
dataaf.to_csv(r"C:\Users\User\Desktop\NASA apps\A Marketplace for Open Science Projects\Data\New data\AFTER NLP\SCIENTIFIC_PHASE2.csv",index=False)
